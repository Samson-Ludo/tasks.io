	...
	function displayTasks(){
		...
		if(localStorage.getItem('tasks') != null){
			...
			$.each(taskList, function(key, value){
				$('#task-table').append('<tr style="color:blue" id="'+ value.id +'">' +
										'<td>' + value.task + '</td>' +
										'<td>' + value.task_priority + '</td>' +
										'<td>' + value.task_date + '</td>' +
										'<td>' + value.task_time + '</td>' +
										'<td><a class="btn btn-default" href="edit.html?id='+ value.id +'">Edit</a> | <a class="btn btn-danger"  href="#" id="remove-task" data-id="'+ value.id +'">Remove</a></td>' +
										'</tr>');
			})
		}
	}
